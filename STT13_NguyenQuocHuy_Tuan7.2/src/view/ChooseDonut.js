...
const ChooseDonut = ({ navigation }) => {
  ...
  const handleSearch = (text) => {
    setSearchText(text);
    // Lọc danh sách xe đạp dựa trên từ khóa tìm kiếm
    const filtereDonut = dataDonut.filter((item) =>
      item.name.toLowerCase().includes(text.toLowerCase())
    );
    setDataDonut(filtereDonut);
  };
  return (
      ...
      >
        ...
        >
          <TouchableOpacity
            ...
            onPress={() =>
              setDataDonut(dataDonut.filter((item) => item.name === "Tasty Donut"))
            }
          >
        ...
        >
          <TouchableOpacity
            ...
            onPress={() =>
              setDataDonut(dataDonut.filter((item) => item.name === "Pink Donut"))
            }
          >
        ...
        >
          <TouchableOpacity
            ...
            onPress={() =>
              setDataDonut(dataDonut.filter((item) => item.name === "Floating Donut"))
            }
          >
